...
def channels_list():
    ...
    itemlist.append( Item( title="[COLOR azure]AnimeTubeIta.com[/COLOR]"   , channel="animetubeita"           , language="IT"    , category="A"   , type="generic", thumbnail="http://i.imgur.com/rQPx1iQ.png"))
    ...
    itemlist.append( Item( title="[COLOR azure]ItaliaFilm.Video HD[/COLOR]"      , channel="italiafilmvideohd"           , language="IT"    , category="B,F"   , type="generic", thumbnail="http://www.italiafilm.video/wp-content/uploads/2015/11/ITALIAFILM-HD-logo.png"))
    ...
    itemlist.append( Item( title="[COLOR azure]Scambiofile[/COLOR]"     , channel="scambiofile"       , language="IT"    , category="F,T" , thumbnail="http://scambiofile.info/themes/default/images/logo.png", type="generic"))
    ...
    itemlist.append( Item( title="[COLOR azure]Streaming01[/COLOR]"    , channel="streaming01"         , language="IT" , category="F"        , type="generic" , extra="Series"))
